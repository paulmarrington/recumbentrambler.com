...
$packageInvalidName->auto_hide_delay = -1;
...
$packageRemoved                  = new DUP_PRO_UI_Messages(DUP_PRO_U::__('Package removed'), DUP_PRO_UI_Messages::ERROR);
...
?><script>
    jQuery(document).ready(function ($) {
        var uploadFileMessageContent = <?php echo json_encode(DupProSnapLibIOU::getInclude(dirname(__FILE__).'/import-message-upload-error.php')); ?>;
...
<?php $packageAlreadyExists->showMessage(); ?>
            ...
            onFileStart: function (e, file)
            {
                ...
                DupPro.ImportManager.packageRowUploading.find('.size').text(DupPro.humanFileSize(file.size));
