...
if (!class_exists('DupProSnapLibIOU', false)) {
    ...
    class DupProSnapLibIOU
    {
        ...
        public static function dirWriteCheckOrMkdir($path, $mode = 'u+rwx', $recursive = false, $context = null)
        {
            ...
            } else if (!is_writable($path) || (function_exists('is_executable') && !is_executable($path))) {
                return self::chmod($path, $mode);
            } else {
                return true;
            }
        ...
        {
            if (!DupProSnapLibIOU::chmod($path, 'u+rwx')) {
                return false;
            }
            ...
            if (function_exists('is_executable') && !is_executable($path) && !DupProSnapLibOSU::isWindows()) {
                return false;
            }
        ...
        {
            if (!DupProSnapLibIOU::chmod($path, 'u+rw')) {
                return false;
            }
