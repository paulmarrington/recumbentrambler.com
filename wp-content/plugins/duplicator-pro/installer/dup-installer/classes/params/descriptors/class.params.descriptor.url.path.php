...
final class DUPX_Paramas_Descriptor_urls_paths implements DUPX_Interface_Paramas_Descriptor
{
    ...
    public static function init(&$params)
    {
        ...
        $params[DUPX_Paramas_Manager::PARAM_WP_ADDON_SITES_PATHS] = new DUPX_Param_item(
            DUPX_Paramas_Manager::PARAM_WP_ADDON_SITES_PATHS,
        ...
        $params[DUPX_Paramas_Manager::PARAM_PATH_UPLOADS_NEW] = new DUPX_Param_item_form(
            ...
            'validateCallback' => function ($value) {
                $homePath       = DUPX_Paramas_Manager::getInstance()->getValue(DUPX_Paramas_Manager::PARAM_PATH_NEW);
                $relativeUpload = DupProSnapLibIOU::getRelativePath($value, $homePath);
                return ($relativeUpload !== false && strlen($relativeUpload) > 0);
            },
