...
class DUPX_Flywheel_Host implements DUPX_Host_interface
{
    ...
    public function isHosting()
    {
        ...
        $testFile = DUPX_Paramas_Manager::getInstance()->getValue(DUPX_Paramas_Manager::PARAM_PATH_NEW).'/.fw-config.php';
    ...
    public function setCustomParams()
    {
        ...
        $paramsManager->setValue(DUPX_Paramas_Manager::PARAM_ARCHIVE_ENGINE_SKIP_WP_FILES, DUP_PRO_Extraction::FILTER_SKIP_WP_CORE);
    }
}