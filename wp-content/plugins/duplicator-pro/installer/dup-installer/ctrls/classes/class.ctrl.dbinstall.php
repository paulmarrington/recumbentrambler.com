...
class DUPX_DBInstall
{
    ...
    public function runCleanupRoutines()
    {
        ...
        $opts_delete = array();
        foreach ((array) json_decode($GLOBALS['DUPX_AC']->opts_delete) as $value) {
        ...
        DUPX_Log::info("- Clean options table ".DUPX_Log::varToString($deleteOptionConds));
        DUPX_DB::mysqli_query($this->dbh, "DELETE FROM `".mysqli_real_escape_string($this->dbh, $table_prefix)."options` WHERE ".implode(' OR ', $deleteOptionConds));
