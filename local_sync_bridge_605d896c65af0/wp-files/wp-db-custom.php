...
class wpdb {
	...
	*/
	...
	public function set_sql_mode($modes = array()) {
		...
		if ($this->use_mysqli) {
			mysqli_query($this->dbh, "SET SESSION sql_mode='NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION'");
		} else {
			mysql_query("SET SESSION sql_mode='NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION'", $this->dbh);
		}
	}
