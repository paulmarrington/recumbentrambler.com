...
class DUPX_Custom_Host_Manager
{
    ...
    public function setManagedHostParams()
    {
        ...
        if (DUPX_InstallerState::getInstance()->getMode() === DUPX_InstallerState::MODE_OVR_INSTALL) {
            ...
            $paramsManager->setValue(DUPX_Paramas_Manager::PARAM_VALIDATION_ACTION_ON_START, DUPX_Validation_manager::ACTION_ON_START_AUTO);
            $paramsManager->setValue(DUPX_Paramas_Manager::PARAM_DB_DISPLAY_OVERWIRE_WARNING, false);
            $paramsManager->setValue(DUPX_Paramas_Manager::PARAM_CPNL_CAN_SELECTED, false);
            $paramsManager->setValue(DUPX_Paramas_Manager::PARAM_DB_HOST, $overwriteData['dbhost']);
            $paramsManager->setValue(DUPX_Paramas_Manager::PARAM_DB_NAME, $overwriteData['dbname']);
            $paramsManager->setValue(DUPX_Paramas_Manager::PARAM_DB_USER, $overwriteData['dbuser']);
            $paramsManager->setValue(DUPX_Paramas_Manager::PARAM_DB_PASS, $overwriteData['dbpass']);
