...
if (!function_exists('get_option_local_sync')) {
	function get_option_local_sync($option) {
		global $wpdb;
		$value = false;
		$sql = $wpdb->prepare("SELECT value FROM " . $wpdb->base_prefix . "local_sync_options WHERE name = %s LIMIT 1", $option);
...
if (!function_exists('network_admin_url')) {
	function network_admin_url( $path = '', $scheme = 'admin' ) {
		$network_admin_url = get_option_local_sync('network_admin_url');
...
if (!function_exists('home_url')) {
	function home_url() {
		return get_option_local_sync('site_url_local_sync');
	}
}
