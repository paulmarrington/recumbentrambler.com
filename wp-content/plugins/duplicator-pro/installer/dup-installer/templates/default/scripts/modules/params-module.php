...
<script>
    ...
    const tablesNameClass = <?php echo DupProSnapJsonU::wp_json_encode(($paramsManager->getFormItemId(DUPX_Paramas_Manager::PARAM_DB_TABLES) . DUPX_Param_item_form_tables::TABLE_NAME_POSTFIX_TNAME)); ?>;
    const tablesNameInputName = <?php echo DupProSnapJsonU::wp_json_encode(DUPX_Paramas_Manager::PARAM_DB_TABLES); ?>;
    ...
    const tablesExtractInputName = <?php echo DupProSnapJsonU::wp_json_encode(DUPX_Paramas_Manager::PARAM_DB_TABLES . DUPX_Param_item_form_tables::TABLE_NAME_POSTFIX_EXTRACT); ?>;
    ...
    const tablesReplaceInputName = <?php echo DupProSnapJsonU::wp_json_encode(DUPX_Paramas_Manager::PARAM_DB_TABLES . DUPX_Param_item_form_tables::TABLE_NAME_POSTFIX_REPLACE); ?>;
